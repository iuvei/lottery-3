<template>
  <div class="orders">
    <nav class="row text-center bg-white text-sm" :class="'active'+optFor">
      <div class="col col-25" @click="changeStatus(1)"><span>全部</span></div>
      <div class="col col-25" @click="changeStatus(2)"><span>待开奖</span></div>
      <div class="col col-25" @click="changeStatus(3)"><span>中奖</span></div>
      <div class="col col-25" @click="changeStatus(4)"><span>未中奖</span></div>
    </nav>
    <ul class="list"
...
<script>
  ...
  import { loadMore, init } from '../index'
  ...
  export default {
    ...
    components: {OrderListItem, NoOrder, InfiniteScrollLoading},
    created () {
      this.loadMore()
    }
  }
...
<style>
  ...
  .orders nav.active1 div:nth-child(1),
  .orders nav.active2 div:nth-child(2),
  .orders nav.active3 div:nth-child(3),
  .orders nav.active4 div:nth-child(4) {
    color: #e73f40;
    border-color: #e73f40;
  }
