<template>
  <div class="article-purchase-heat" v-show="list.length">
    <img class="heat" src="../assets/article_purchase_heat.png" alt="">
    <div v-for="(i,index) in list" class="item" :class="(index+1)!==list.length&&'imaginary'">
      <div class="item-left">
      ...
      <div class="item-right" @click="goTarget(i)">
