<template>
  <div>
    ...
    <div class="minimum-guarantee">
      <span>保底</span><span style="color: #51af31">{{ percentage }}%</span>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      rotate () {
        ...
        rotateZ[0] = (redAngle[0] * 3.6) - 180;
        rotateZ[1] = (redAngle[1] * 3.6) - 180;
        rotateZ[2] = (redAngle[2] * 3.6) - 180;
        rotateZ[3] = (redAngle[3] * 3.6) - 180;
        return rotateZ
      }
    },
    methods: {}
  ...
  function dispose (val3, val4) {
    ...
    if (val3 > 50) {
      ...
      arr[0] = val3;
      arr[2] = val3 + val4 > 50 ? 50 : val3 + val4;
      arr[1] = 0;
      arr[3] = arr[2] === 50 ? (val3 + val4) - 50 : 0;
    }
    return arr
  }
